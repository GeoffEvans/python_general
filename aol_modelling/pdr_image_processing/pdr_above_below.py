...
def save_figs_for_z_stack_expt(pdr):
    file_name = 'C:\\Users\\Geoff\\Dropbox\\Expts\\PDR expts\\25 Feb 2015\\_%s_%s\\Zstack Images\\GreenChannel_00%s.tif'
    save_name = '.\\above_below\\z%s_pdr%s_expt.%s'
    id_list = ['06', '10']
    norm_zs = [-0.2462, 0, 0.2341]
    abs_z = [160, 0, -160]
...
if __name__ == '__main__':
    #save_figs_for_z_stack_expt(None)
    #save_figs_for_z_stack_expt(1)
    save_figs_for_z_stack_model(None)
