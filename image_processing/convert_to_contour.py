...
def get_png(pdr):
    img = misc.imread('C:\Users\Geoff\Desktop\PDR expts\\%s\GreenChannel_0007.jpg' % pdr)
    #plt.figure()
    ...
    cset = plt.contour(angles, angles, img_blur_norm, np.arange(0.2,1,0.1),linewidths=1)
